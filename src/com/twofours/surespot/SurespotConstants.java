...
public class SurespotConstants {
	public class EventFilters {
		...
		public static final String FRIEND_INVITE_EVENT = "friend_invite_event";
		public static final String SHOW_CHAT_EVENT = "show_chat_event";
	}
	...
	public class ExtraNames {
		...
		public static final String FRIEND_INVITE_NAME = "friend_invite_name";
