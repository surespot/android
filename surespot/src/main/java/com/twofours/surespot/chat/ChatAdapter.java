...
//                }
        ...
        if (item.getMimeType().equals(SurespotConstants.MimeTypes.TEXT) || item.getMimeType().equals(SurespotConstants.MimeTypes.GIF_LINK) || item.getMimeType().equals(SurespotConstants.MimeTypes.FILE)) {
